...
const certificationsData: Certificate[] = [
  {
    ...
    provider: 'Guvi Certification & HackerRank',
    date: 'December 2024',
    credentialId: 'GUVI-PY-883172',
    skillsVerified: ['Python Core', 'Data Structures', 'OOPs', 'Functional Programming'],
  ...
  },
  {
    ...
    date: 'November 2024',
    credentialId: 'HR-SQL-ADV-9921',
    skillsVerified: ['Subqueries', 'Window Functions', 'Joins', 'Schema Design', 'Optimizations'],
  ...
  },
  {
    ...
    provider: 'Microsoft Partner Training',
    date: 'February 2025',
    credentialId: 'MS-PBI-881920',
    skillsVerified: ['Data modeling', 'DAX Formulas', 'Report Publishing', 'KPI Dashboards'],
    iconColor: 'text-[#F2C811]',
    bgColor: 'rgba(242, 200, 17, 0.1)',
  },
  {
    id: 4,
    ...
    date: 'March 2025',
    credentialId: 'GGL-DA-482910',
    skillsVerified: ['Data Cleansing', 'Pandas & NumPy', 'Spreadsheets', 'Data Visualizations'],
  ...
  },
  {
    ...
    provider: 'Udemy & Open Source Curriculum',
    date: 'October 2024',
    credentialId: 'UD-WD-771928',
    skillsVerified: ['HTML5 & CSS3', 'React JS', 'Express.js', 'RESTful Endpoints', 'Git Workflow'],
  ...
  },
  {
    ...
    provider: 'DeepLearning.AI & IBM Skills',
    date: 'January 2025',
    credentialId: 'DLAI-ML-339210',
    skillsVerified: ['Regression Models', 'Classification', 'LLM Prompt Engineering', 'RAG Frameworks'],
